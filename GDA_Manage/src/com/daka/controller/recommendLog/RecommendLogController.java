package com.daka.controller.recommendLog;
...
public class RecommendLogController {
    ...
    public Object toList(HttpServletRequest request) {
        ModelAndView mv = new ModelAndView("/recommendLog/list");
        return mv;
    }
    ...
    public Object queryData(HttpServletRequest request) {
        ...
        Page page = new Page();
        page.setPd(pd);
        List<PageData> recommendLogList = null;
        try {
            recommendLogList = recommendLogService.queryRecommendLoglistPage(page);
            JSONObject result = new JSONObject();
            result.put("status", "200");
            result.put("message", "");
            result.put("count", page.getTotalResult());
            result.put("data", recommendLogList);
            return result;
        } catch (Exception e) {
            e.printStackTrace();
